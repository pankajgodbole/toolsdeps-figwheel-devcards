...
return cljs.core.map.call(null,(function (p1__8185_SHARP_){
return html_coll.item(p1__8185_SHARP_);
...
return cljs.core.some.call(null,((function (rel,temp__5753__auto__){
return (function (p1__8186_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__8186_SHARP_);
});})(rel,temp__5753__auto__))
...
var ctx_8187 = cvs.getContext("2d");
ctx_8187.fillStyle = color;

ctx_8187.fillRect((0),(0),size,size);
