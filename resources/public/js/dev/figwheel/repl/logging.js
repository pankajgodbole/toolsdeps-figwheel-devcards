...
try{return cljs.core.reduce.call(null,cljs.core._PLUS_,cljs.core.map.call(null,cljs.core._STAR_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(100000000000),(10000),(1)], null),cljs.core.map.call(null,(function (p1__11412_SHARP_){
return parseInt(p1__11412_SHARP_);
...
var G__11414_11416 = c_11415.getFormatter();
goog.object.set(G__11414_11416,"showAbsoluteTime",false);

goog.object.set(G__11414_11416,"showRelativeTime",false);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__11417_SHARP_){
return goog.object.get(goog.debug.Logger.Level,p1__11417_SHARP_);
