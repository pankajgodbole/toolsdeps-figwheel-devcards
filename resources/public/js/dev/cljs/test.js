...
var G__14528 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__14528,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__14528;
}
});
...
var len__4641__auto___14533 = arguments.length;
var i__4642__auto___14534 = (0);
while(true){
if((i__4642__auto___14534 < len__4641__auto___14533)){
args__4647__auto__.push((arguments[i__4642__auto___14534]));

var G__14535 = (i__4642__auto___14534 + (1));
i__4642__auto___14534 = G__14535;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq14530){
...
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14531,G__14532,seq14530__$2);
});
...
var line = cljs.core.get.call(null,map__14537__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__14537__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__14537,map__14537__$1,file,line,column){
return (function (p1__14536_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__14536_SHARP_));
});})(map__14537,map__14537__$1,file,line,column))
...
var temp__5753__auto___14539 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___14539)){
var message_14540 = temp__5753__auto___14539;
...
var temp__5753__auto___14541 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___14541)){
var message_14542 = temp__5753__auto___14541;
...
var output_dir = "resources/public/js/dev";
var output_dir__$1 = (function (){var G__14543 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14543),"/"].join('');
} else {
return G__14543;
}
})();
...
var temp__5751__auto__ = (function (){var and__4036__auto__ = typeof exception.stack === 'string';
if(and__4036__auto__){
var G__14545 = exception.stack;
var G__14545__$1 = (((G__14545 == null))?null:clojure.string.split_lines.call(null,G__14545));
var G__14545__$2 = (((G__14545__$1 == null))?null:cljs.core.get.call(null,G__14545__$1,depth));
if((G__14545__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__14545__$2);
}
} else {
...
var vec__14546 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__14546,(0),null);
var column = cljs.core.nth.call(null,vec__14546,(1),null);
var vec__14549 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__14549,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__14549,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__14549,(2),null);
...
var m__$1 = (function (){var G__14552 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__14556 = (function (){var G__14555 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__14555);
} else {
return G__14555;
}
})();
...
return cljs.core.vary_meta.call(null,G__14557,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__14561 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__14561,(0),null);
var types = vec__14561;
...
return cljs.core.map.call(null,(function (p__14564){
var vec__14565 = p__14564;
var ns = cljs.core.nth.call(null,vec__14565,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__14565,(1),null);
return ((function (vec__14565,ns,vars__$1){
return (function (){
...
var G__14568 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__14568,G__14568__$1,env,once_fixtures,each_fixtures,vec__14565,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__14568,G__14568__$1,env,once_fixtures,each_fixtures,vec__14565,ns,vars__$1){
return (function (){
var seq__14569 = cljs.core.seq.call(null,vars__$1);
var chunk__14570 = null;
var count__14571 = (0);
var i__14572 = (0);
while(true){
if((i__14572 < count__14571)){
var v = cljs.core._nth.call(null,chunk__14570,i__14572);
var temp__5753__auto___14574 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5753__auto___14574)){
var t_14575 = temp__5753__auto___14574;
each_fixture_fn.call(null,((function (seq__14569,chunk__14570,count__14571,i__14572,t_14575,temp__5753__auto___14574,v,each_fixture_fn,G__14568,G__14568__$1,env,once_fixtures,each_fixtures,vec__14565,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14575)));
});})(seq__14569,chunk__14570,count__14571,i__14572,t_14575,temp__5753__auto___14574,v,each_fixture_fn,G__14568,G__14568__$1,env,once_fixtures,each_fixtures,vec__14565,ns,vars__$1))
);
} else {
}


var G__14576 = seq__14569;
var G__14577 = chunk__14570;
var G__14578 = count__14571;
var G__14579 = (i__14572 + (1));
seq__14569 = G__14576;
chunk__14570 = G__14577;
count__14571 = G__14578;
i__14572 = G__14579;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq.call(null,seq__14569);
if(temp__5753__auto__){
var seq__14569__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__14569__$1)){
var c__4461__auto__ = cljs.core.chunk_first.call(null,seq__14569__$1);
var G__14580 = cljs.core.chunk_rest.call(null,seq__14569__$1);
var G__14581 = c__4461__auto__;
var G__14582 = cljs.core.count.call(null,c__4461__auto__);
var G__14583 = (0);
seq__14569 = G__14580;
chunk__14570 = G__14581;
count__14571 = G__14582;
i__14572 = G__14583;
continue;
} else {
var v = cljs.core.first.call(null,seq__14569__$1);
var temp__5753__auto___14584__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5753__auto___14584__$1)){
var t_14585 = temp__5753__auto___14584__$1;
each_fixture_fn.call(null,((function (seq__14569,chunk__14570,count__14571,i__14572,t_14585,temp__5753__auto___14584__$1,v,seq__14569__$1,temp__5753__auto__,each_fixture_fn,G__14568,G__14568__$1,env,once_fixtures,each_fixtures,vec__14565,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14585)));
});})(seq__14569,chunk__14570,count__14571,i__14572,t_14585,temp__5753__auto___14584__$1,v,seq__14569__$1,temp__5753__auto__,each_fixture_fn,G__14568,G__14568__$1,env,once_fixtures,each_fixtures,vec__14565,ns,vars__$1))
);
} else {
}


var G__14586 = cljs.core.next.call(null,seq__14569__$1);
var G__14587 = null;
var G__14588 = (0);
var G__14589 = (0);
seq__14569 = G__14586;
chunk__14570 = G__14587;
count__14571 = G__14588;
i__14572 = G__14589;
continue;
}
} else {
...
});})(each_fixture_fn,G__14568,G__14568__$1,env,once_fixtures,each_fixtures,vec__14565,ns,vars__$1))
);
});})(each_fixture_fn,G__14568,G__14568__$1,env,once_fixtures,each_fixtures,vec__14565,ns,vars__$1))
], null);
