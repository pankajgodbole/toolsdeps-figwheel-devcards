...
var G__10824 = devtools.prefs.pref.call(null,v);
v = G__10824;
continue;
} else {
return v;
...
}catch (e10827){var _e__9841__auto__ = e10827;
return false;
}})();
...
}catch (e10831){var _e__9841__auto__ = e10831;
return false;
}})();
...
}catch (e10833){var _e__9841__auto__ = e10833;
return false;
}}
}
});
...
var vec__10835 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10835,(0),null);
var name = cljs.core.nth.call(null,vec__10835,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10838_SHARP_);
}),template);
});
