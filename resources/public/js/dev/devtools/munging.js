...
var o10722 = temp__5751__auto__;
var temp__5751__auto____$1 = (o10722["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o10723 = temp__5751__auto____$1;
return (o10723["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9834__auto__ = f;
return (o__9834__auto__["toString"]).call(o__9834__auto__);
} else {
return "";
}
}catch (e10724){var _ = e10724;
return "";
}});
...
try{var o__9834__auto___10726 = t;
(o__9834__auto___10726["cljs$lang$ctorPrWriter"]).call(o__9834__auto___10726,t,writer);
}catch (e10725){var __10727 = e10725;
}
...
var char_code = (function (){var o__9834__auto__ = (new String(char$));
return (o__9834__auto__["charCodeAt"]).call(o__9834__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9834__auto__ = String;
return (o__9834__auto__["fromCharCode"]).call(o__9834__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10728 = num_code;
switch (G__10728) {
case (1):
return (185);
...
var o__9834__auto__ = String;
return (o__9834__auto__["fromCharCode"]).call(o__9834__auto__,superscript_code);
});
/**
...
}catch (e10730){var _e__9841__auto__ = e10730;
return false;
}})())){
...
var vec__10731 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10731,(0),null);
...
var or__4047__auto__ = (function (){var temp__5751__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5751__auto__)){
...
if(cljs.core.truth_(temp__5751__auto__)){
var o10734 = temp__5751__auto__;
var temp__5751__auto____$1 = (o10734["dependencies_"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o10735 = temp__5751__auto____$1;
return (o10735["nameToPath"]);
} else {
return null;
}
} else {
...
args__4647__auto__.push((arguments[i__4642__auto___10743]));
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10738){
var vec__10739 = p__10738;
var ns_detector = cljs.core.nth.call(null,vec__10739,(0),null);
...
var G__10745 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10746 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10745;
remaining_tokens = G__10746;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10736){
var G__10737 = cljs.core.first.call(null,seq10736);
var seq10736__$1 = cljs.core.next.call(null,seq10736);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10737,seq10736__$1);
});
...
var vec__10750 = cljs.core.split_with.call(null,(function (p1__10749_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10749_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10750,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10750,(1),null);
...
var vec__10753 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10753,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10753,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10756 = cljs.core.rest.call(null,remaining_tokens);
var G__10757 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10756;
name_tokens = G__10757;
continue;
} else {
...
var vec__10760 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10760,(0),null);
var arity = cljs.core.nth.call(null,vec__10760,(1),null);
var vec__10763 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10763,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10763,(1),null);
var vec__10766 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10766,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10766,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10766,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10766,(3),null);
...
var vec__10772 = result;
var munged_ns = cljs.core.nth.call(null,vec__10772,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10772,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10772,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10772,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10772,(4),null);
var arity = cljs.core.nth.call(null,vec__10772,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__10776 = temp__5751__auto__;
var munged_name = cljs.core.nth.call(null,vec__10776,(0),null);
var args = cljs.core.nth.call(null,vec__10776,(1),null);
var vec__10779 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10779,(0),null);
var name = cljs.core.nth.call(null,vec__10779,(1),null);
...
var G__10782 = (arity + (1));
var G__10783 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10784){
var vec__10785 = p__10784;
var arity = cljs.core.nth.call(null,vec__10785,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10785,(1),null);
...
return cljs.core.get.call(null,arities,p1__10788_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__10789_SHARP_);
...
var args__4647__auto__ = [];
var len__4641__auto___10796 = arguments.length;
var i__4642__auto___10797 = (0);
while(true){
if((i__4642__auto___10797 < len__4641__auto___10796)){
args__4647__auto__.push((arguments[i__4642__auto___10797]));

var G__10798 = (i__4642__auto___10797 + (1));
i__4642__auto___10797 = G__10798;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10792){
var vec__10793 = p__10792;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10793,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10790){
var G__10791 = cljs.core.first.call(null,seq10790);
var seq10790__$1 = cljs.core.next.call(null,seq10790);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10791,seq10790__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__10801__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10801__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10801__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10801__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10802 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10802,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10802,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10802,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10802,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10802,(4),null);
var arity = cljs.core.nth.call(null,vec__10802,(5),null);
...
var o__9834__auto__ = f;
return (o__9834__auto__["getBasis"]).call(o__9834__auto__);
});
/**
...
}catch (e10806){var _e__9841__auto__ = e10806;
...
var G__10807 = (obj[cljs.core.first.call(null,path)]);
var G__10808 = cljs.core.rest.call(null,path);
obj = G__10807;
path = G__10808;
continue;
} else {
...
return (function (accum,p__10809){
var vec__10810 = p__10809;
var bit = cljs.core.nth.call(null,vec__10810,(0),null);
var protocol = cljs.core.nth.call(null,vec__10810,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10813){
var vec__10814 = p__10813;
var ns = cljs.core.nth.call(null,vec__10814,(0),null);
var name = cljs.core.nth.call(null,vec__10814,(1),null);
var selector = cljs.core.nth.call(null,vec__10814,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__10819,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10819,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__10819,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__10817_SHARP_){
return (obj[cljs.core.first.call(null,p1__10817_SHARP_)]);
});})(name,sorted_matches,vec__10819,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
